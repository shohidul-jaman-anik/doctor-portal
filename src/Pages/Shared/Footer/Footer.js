        ...
        <footer className="text-center lg:text-left bg-gray-800 text-gray-600 mt-10">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                ...
                <div className="flex justify-center">
                    <Link to="#!" className="mr-6 text-secondary">
          ...
          ">
                            ...
                            <p className='text-primary'> Health Solution</p>
                        </h6>
                        <p className="text-white">
                            Established in 2002, Health Solution is an advanced tertiary care, multi-specialty hospital equipped with 54 beds and spread over an area of 15000 sq. ft.
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start text-primary">
                            Service
                        </h6>
                        <p className="mb-4 ">
                            <p className=" text-white">General Surgery</p>
                        </p>
                        <p className="mb-4 ">
                            <p className=" text-white">Orthopedics</p>
                        </p>
                        <p className="mb-4 ">
                            <p className=" text-white">Gynecologist</p>
                        </p>
                        <p className="mb-4">
                            <p className=" text-white">Neurology</p>
                        </p>
                        <p className="mb-4 ">
                            <p className=" text-white">Dental</p>
                        </p>
                        <p>
                            <p className=" text-white"> Cosmetology</p>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start text-primary">
                        ...
                        <p className="mb-4">
                            <Link to="/contact" className=" text-white">Home</Link>
                        </p>
                        <p className="mb-4">
                    ...
                    <div className="">
                        ...
                        <p className="flex items-center justify-center md:justify-start mb-4">
                            ...
                            <p className='text-white'>Health Solution@gmail.com</p>
                        </p>
                        <p className="flex items-center justify-center md:justify-start mb-4">
